...
@section('title', 'Prakiraan dan Analisis Hujan Bulanan')
@section('content')
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="{{route('pahb')}}" enctype="multipart/form-data">
              @csrf 
            ...
            <tbody>
                @foreach($pahb as $content)
                    <tr>
                        ...
                        <td>
                            <form method="post" action="{{ url(config('app.root').'/pahb/'.$content->id) }}" style="display:inline">
                              @method('DELETE')
                              @csrf
