...
@section('title', 'Prakiraan Cuaca Wilayah Pelayaran')
@section('content')
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="{{route('pcwp')}}" enctype="multipart/form-data">
              @csrf 
            ...
            <tbody>
                @foreach($pcwp as $content)
                    <tr>
                        ...
                        <td>
                            <form method="post" action="{{ url(config('app.root').'/pcwp/'.$content->id) }}" style="display:inline">
                              @method('DELETE')
                              @csrf
