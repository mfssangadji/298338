...
@section('title', 'Vulcanic Ash Activities Report')
@section('content')
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="{{route('veaer')}}" enctype="multipart/form-data">
              @csrf 
            ...
            <tbody>
                @foreach($veaer as $content)
                    <tr>
                        ...
                        <td>
                            <form method="post" action="{{ url(config('app.root').'/veaer/'.$content->id) }}" style="display:inline">
                              @method('DELETE')
                              @csrf
