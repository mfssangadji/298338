  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="{{route('flyer')}}" enctype="multipart/form-data">
              @csrf 
            ...
            <tbody>
                @foreach($flyer as $content)
                    <tr>
                        ...
                        <td>
                            <form method="post" action="{{ url(config('app.root').'/flyer/'.$content->id) }}" style="display:inline">
                              @method('DELETE')
                              @csrf
