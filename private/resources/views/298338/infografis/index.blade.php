  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="{{route('infografis')}}" enctype="multipart/form-data">
              @csrf 
            ...
            <tbody>
                @foreach($infografis as $content)
                    <tr>
                        ...
                        <td>
                            <form method="post" action="{{ url(config('app.root').'/infografis/'.$content->id) }}" style="display:inline">
                              @method('DELETE')
                              @csrf
