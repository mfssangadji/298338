...
@section('title', 'Prakiraan Cuaca Pelabuhan')
@section('content')
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="{{route('pcp')}}" enctype="multipart/form-data">
              @csrf 
            ...
            <tbody>
                @foreach($pcp as $content)
                    <tr>
                        ...
                        <td>
                            <form method="post" action="{{ url(config('app.root').'/pcp/'.$content->id) }}" style="display:inline">
                              @method('DELETE')
                              @csrf
