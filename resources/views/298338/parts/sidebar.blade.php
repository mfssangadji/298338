  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview {{active('veaer')}} {{active('flightdoc')}} {{active('aerodrom')}}">
      ...
      <ul class="treeview-menu">
        ...
        <li class="{{active('flightdoc')}}">
          <a href="{{ route('flightdoc') }}"><i class="fa fa-circle"></i> Flight Document</a>
        </li>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        <li>
          <a href="{{ url('catalog-data') }}"><i class="fa fa-circle"></i> Permintaan Data</a>
        </li>
        <li>
          <a href="{{ url('catalog-data') }}"><i class="fa fa-circle"></i> Katalog Data</a>
        </li>
      </ul>
    </li>
    ...
    <li class="treeview {{active('buletin')}} {{active('infografis')}} {{active('flyer')}} {{active('article')}}">
      <a href="#">
      ...
      <ul class="treeview-menu">
        ...
        <li><a href="{{ url('article') }}"><i class="fa fa-circle"></i> Artikel</a></li>
      </ul>
    </li>
    <li class="treeview">
      <a href="#">
    ...
    <li><a href="{{ url('logout') }}"><i class="fa fa-sign-out text-danger"></i> <span>Logout</span></a></li>
  </ul>
</section>