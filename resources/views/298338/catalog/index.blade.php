  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="{{route('catalog-data')}}" enctype="multipart/form-data">
              @csrf 
            ...
            <tbody>
                @foreach($catalog as $content)
                    <tr>
                        ...
                        <td>
                            <form method="post" action="{{ url(config('app.root').'/catalog-data/'.$content->id) }}" style="display:inline">
                              @method('DELETE')
                              @csrf
