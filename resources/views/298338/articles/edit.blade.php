	...
	<div class="row">
	    ...
	    <div class="col-md-12">
	      ...
	      <div class="box box-primary">
	        ...
	        <!-- /.box-header -->
	        <!-- form start -->
	        <form role="form" method="post" action="{{ url(config('app.root').'/articles/'.$article->id) }}">
	          @csrf
	          @method('PATCH')
	          <div class="box-body">
	            ...
	            <div class="form-group @error('title') has-error @enderror">
	              ...
	              <input type="text" class="form-control" value="{{ $article->title }}" id="title" name="title" placeholder="Masukan judul artikel">
	              @error('title')
	            ...
	            <div class="form-group">
                	...
                	@error('content')
                 	...
                 	<textarea class="textarea" name="description" 
                      style="width: 100%; height: 500px; font-size: 14px; line-height: 18px;padding: 10px;">{{$article->description}}</textarea>
               	</div>
