  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="{{route('kalei')}}" enctype="multipart/form-data">
              @csrf 
            ...
            <tbody>
                @foreach($kalei as $content)
                    <tr>
                        ...
                        <td>
                            <form method="post" action="{{ url(config('app.root').'/kalei/'.$content->id) }}" style="display:inline">
                              @method('DELETE')
                              @csrf
