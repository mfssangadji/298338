  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="{{route('pm')}}" enctype="multipart/form-data">
              @csrf 
            ...
            <tbody>
                @foreach($pm as $content)
                    <tr>
                        ...
                        <td>
                            <form method="post" action="{{ url(config('app.root').'/pm/'.$content->id) }}" style="display:inline">
                              @method('DELETE')
                              @csrf
