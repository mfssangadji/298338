...
<?php $__env->startSection('content'); ?>
	...
	<div class="container floated">
		<div class="sixteen floated page-title">
			<h2>Prakiraan Cuaca Pelabuhan</h2>
			<nav id="breadcrumbs">
				<ul>
					<li>You are here:</li>
					<li><a href="<?php echo e(route('welcome')); ?>">Home</a></li>
					<li>Meteo</li>
					<li>Prakiraan Cuaca Pelabuhan</li>
				</ul>
			</nav>
		</div>
	</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pro\stamet-ternate\resources\views/main/pcp.blade.php ENDPATH**/ ?>