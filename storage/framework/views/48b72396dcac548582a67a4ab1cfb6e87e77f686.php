...
<?php $__env->startSection('title', 'Informasi Hari Tanpa Hujan'); ?>
  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div class="box-body">
            <form method="post" action="<?php echo e(route('ihth')); ?>" enctype="multipart/form-data">
              <?php echo csrf_field(); ?> 
          ...
          <table class="table table-bordered table-striped" id="postTable">
            ...
            <tbody>
                <?php $__currentLoopData = $ihth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <form method="post" action="<?php echo e(url(config('app.root').'/ihth/'.$content->id)); ?>" style="display:inline">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('298338.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pro\stamet-ternate\resources\views/298338/ihth/index.blade.php ENDPATH**/ ?>