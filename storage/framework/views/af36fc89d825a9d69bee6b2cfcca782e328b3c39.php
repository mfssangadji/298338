...
================================================== -->
<meta charset="utf-8">
<title>BMKG - <?php echo $__env->yieldContent('title'); ?></title>
...
<link rel="stylesheet" href="<?php echo e(asset('css/colors/navy.css')); ?>" id="colors">
...
<!-- Java Script
================================================== -->
<script src="<?php echo e(asset('jquery-1.11.0.min.js')); ?>"></script>
<script src="<?php echo e(asset('jquery-migrate-1.2.1.min.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/jquery.flexslider.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/jquery.selectnav.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/jquery.twitter.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/jquery.modernizr.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/jquery.easing.1.3.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/jquery.contact.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/jquery.isotope.min.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/jquery.jcarousel.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/jquery.fancybox.min.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/jquery.transit-modified.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/layerslider.transitions.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/layerslider.kreaturamedia.jquery.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/greensock.js')); ?>"></script>
<script src="<?php echo e(asset('scripts/jquery.shop.js')); ?>"></script>
...
<div class="container">
	...
	<header id="header">
		...
		<div class="ten columns">
			<div id="logo">
				<h1><a href="#"><img src="<?php echo e(asset('logo.png')); ?>" /></a></h1>
...
<ul class="menu" id="responsive">
	...
	<li><a href="<?php echo e(route('welcome')); ?>" id="current"><i class="halflings white home"></i> Home</a></li>
	...
	<li><a href="#"><i class="halflings white certificate"></i> Klimatologi</a>
		<!-- Second Level / Start -->
		<ul>
			<li class="longli"><a href="<?php echo e(route('ppahb')); ?>">Prakiraan & Analisis Hujan Bulanan</a></li>
			<li class="longli"><a href="<?php echo e(route('ppm')); ?>">Prakiraan Musim</a></li>
			<li class="longli"><a href="<?php echo e(route('pihth')); ?>">Informasi Hari Tanpa Hujan</a></li>
			<li class="longli"><a href="<?php echo e(route('pipt')); ?>">Indeks Presipitasi Terstandarisasi</a></li>
			<li class="longli"><a href="<?php echo e(route('pkalei')); ?>">Kaleidoskop Iklim</a></li>
		</ul>
		<!-- Second Level / End -->
	</li>

	<li><a href="<?php echo e(url('gallery')); ?>"><i class="halflings white picture"></i> Gallery Kegiatan</a></li>
</ul>
</nav>
<div class="clearfix"></div>
...
</html><?php /**PATH C:\xampp\htdocs\pro\stamet-ternate\resources\views/layouts/app.blade.php ENDPATH**/ ?>