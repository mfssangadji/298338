...
<?php $__env->startSection('title', 'Gallery '.$img->album->name); ?>
<?php $__env->startSection('content'); ?>
	...
	<div class="container floated">
		...
		<div class="sixteen floated page-title">
			...
			<h2><?php echo e($img->album->name); ?></h2>
	...
	<div class="container">
		<div class="sixteen columns">
			...
			<section class="flexslider">
				<ul class="slides">
					<li>
						<a href="/docs/<?php echo e($img->file); ?>" rel="fancybox-gallery" title="<?php echo e($img->description); ?>">
							<img src="/docs/<?php echo e($img->file); ?>" alt="" style="height: 500px !important; width: 100% !important; object-fit: cover" />
						</a>
					</li>
				</ul>
			</section>
	...
	<div class="container" style="margin-top: 30px;">
		...
		<div class="twelve columns">
			<p><?php echo e(strip_tags($img->description)); ?></p>
		</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pro\stamet-ternate\resources\views/main/image_detail.blade.php ENDPATH**/ ?>