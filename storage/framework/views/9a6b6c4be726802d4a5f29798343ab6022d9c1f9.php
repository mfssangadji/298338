...
<?php $__env->startSection('title', 'Gelombang Tinggi'); ?>
	...
	<div class="container floated">
		...
		<section class="comments-sec">
			<ol class="commentlist">
				<?php $i=1; ?>
				<?php $__currentLoopData = $pdgt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pdgt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php if($i==1): ?>
						<li>
							<div class="comment">
								<div class="avatar">
								...
								<div class="comment-des">
									<div class="comment-by"><strong><?php echo e($pdgt->created_at->format("d F Y")); ?> (<?php echo e($pdgt->created_at->format("h:i A")); ?>)</strong>
										<span class="reply">
											<a href="#">Share</a>
										</span>
									</div>
									<p><?php echo e($pdgt->content); ?></p>
								</div>
							</div>
						</li>
						<?php $i++; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pro\stamet-ternate\resources\views/main/pdgt.blade.php ENDPATH**/ ?>