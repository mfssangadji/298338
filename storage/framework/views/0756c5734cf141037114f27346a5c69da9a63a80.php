    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Prakiraan Musim</h3>
        </div>
        <div class="box-body">
          ...
          <table class="table table-bordered table-striped" id="postTable">
            ...
            <tbody>
                <?php $__currentLoopData = $pm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <form method="post" action="<?php echo e(url(config('app.root').'/pm/'.$content->id)); ?>" style="display:inline">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('298338.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pro\stamet-ternate\resources\views/298338/pm/index.blade.php ENDPATH**/ ?>