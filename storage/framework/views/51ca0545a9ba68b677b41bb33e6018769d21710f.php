...
<?php $__env->startSection('title', 'Peringatan Dini Gelombang Tinggi'); ?>
      ...
      <div class="box">
        ...
        <div class="box-body">
          <?php if(Request::segment(4) == "edit"): ?>
            <form method="post" action="<?php echo e(route('pdgt').'/'.$content->id); ?>">
              <?php echo csrf_field(); ?> 
          ...
          <?php else: ?>
            <form method="post" action="<?php echo e(route('pdgt')); ?>">
              <?php echo csrf_field(); ?> 
              <div class="form-group">
            ...
            <tbody>
                <?php $__currentLoopData = $contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(url(config('app.root').'/pdgt/'.$content->id.'/edit')); ?>" class="badge badge-success">edit</a> | 
                            <form method="post" action="<?php echo e(url(config('app.root').'/pdgt/'.$content->id)); ?>" style="display:inline">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('298338.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pro\stamet-ternate\resources\views/298338/pdgt/index.blade.php ENDPATH**/ ?>