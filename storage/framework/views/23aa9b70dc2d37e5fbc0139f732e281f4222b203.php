<section class="sidebar">
  <div class="user-panel">
    ...
    <div class="pull-left image">
      <img src="<?php echo e(asset('lte/dist/img/user2-160x160.jpg')); ?>" class="img-circle">
    </div>
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <?php if(auth()->user()->status == 1): ?>
      ...
      <li class="treeview <?php echo e(active('veaer')); ?> <?php echo e(active('flightdoc')); ?> <?php echo e(active('aerodrom')); ?>">
        ...
        <ul class="treeview-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo e(route('flightdoc-users')); ?>"><i class="fa fa-users text-blue"></i> Pengguna</a></li>
              <li class="">
                <a href="<?php echo e(route('flightdoc')); ?>"><i class="fa fa-circle"></i>
                  Dokumen
                </a>
              </li>
            </ul>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li>
            <a href="<?php echo e(route('permintaan-data')); ?>"><i class="fa fa-circle"></i> Permintaan Data</a>
          </li>
          <li>
            <a href="<?php echo e(route('catalog-data')); ?>"><i class="fa fa-circle"></i> Katalog Data</a>
          </li>
        </ul>
      </li>
    ...
    <li><a href="<?php echo e(route('logout')); ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-sign-out text-danger"></i> <span>Logout</span></a></li>
  </ul>
