	...
	<div class="row">
	    ...
	    <div class="col-md-12">
	      ...
	      <div class="box box-primary">
	        ...
	        <!-- /.box-header -->
	        <!-- form start -->
	        <form role="form" method="post" action="<?php echo e(route('flightdoc-users').'/'.$fdu->id); ?>">
	          <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
	              ...
	              <input type="text" class="form-control" value="<?php echo e($fdu->name); ?>" id="name" name="name" placeholder="Masukan nama">
...
unset($__errorArgs, $__bag); ?>">
	              ...
	              <input type="email" class="form-control" value="<?php echo e($fdu->email); ?>" id="email" name="email" placeholder="Masukan email">
...
unset($__errorArgs, $__bag); ?>">
	              ...
	              <input type="text" value="<?php echo e($fdu->password); ?>" class="form-control" id="password" name="password" placeholder="Masukan password">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('298338.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pro\stamet-ternate\resources\views/298338/flightdocusers/edit.blade.php ENDPATH**/ ?>